...
async def generate_leave_card(member_name: str, member_avatar_url: str, member_count: int, leave_text: str = None, banner_path: str = None, server_ip: str = "AMZCRAFT.TOP:25565"):
