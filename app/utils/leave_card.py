...
async def generate_leave_card(member_name: str, member_avatar_url: str, member_count: int, leave_text: str = None, banner_path: str = None, server_ip: str = "AMZCRAFT.XYZ:25565"):
    ...
    # Title
    draw.text((20, 15), "Goodbye from AmzCraft", fill=(255, 255, 255), font=title_font)
    
    # Leave text
    if leave_text:
        y_pos = 45
        for line in leave_text.split('\n')[:3]:
            if line.strip():
